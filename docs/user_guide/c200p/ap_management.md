...
<img src="../../../images/noteicon.webp" alt="" /> A maxium of 10 APs or 100 clients are allowed in *Main Router and AP Controller* mode; while a maxium of 200 APs are allowed in *AP Controller* mode.
...
<img src="../../../images/c200p/ap-list.webp" alt="" width="800px" style="border: 1px solid #eee; display:block; margin:0 auto;" />
...
- Action
    - <img src="../../../images/c200p/view.webp" alt=""/>: View AP details, including Overview, Radio, C lients and SSID.
    - <img src="../../../images/c200p/config.webp" alt=""/>: Configure the settings, including Name, LED Status, and 2.4GHz/5GHz channel, etc.
    - <img src="../../../images/c200p/forget.webp" alt=""/>: Forget and remove AP from controller but still in the network.
    - <img src="../../../images/c200p/reboot.webp" alt=""/>: Reboot the AP system remotely for fixes/updates.
...
<img src="../../../images/c200p/ap-group.webp" alt="" width="800px" style="border: 1px solid #eee; display:block; margin:0 auto;" />

**How to create an AP Group?**

1. Click <img src="../../../images/c200p/ap-group-add.webp" alt="" width="50px"/> and create a name for the group. Click *Save & Apply*.
<img src="../../../images/c200p/ap-group-create.webp" alt="" width="500px" style="border: 1px solid #eee; display:block; margin:0 auto;" />

2. Click <img src="../../../images/c200p/view.webp" alt="" width="15px"/> and then <img src="../../../images/c200p/ap-group-add.webp" alt="" width="50px"/>, select a groupable AP to add it into the group. Click *Save & Apply*.
<img src="../../../images/c200p/ap-group-create4.webp" alt="" width="500px" style="border: 1px solid #eee; display:block; margin:0 auto;" />

**How to manage the APs in the same AP group?**

- <img src="../../../images/c200p/config.webp" alt=""/>: Batch-configure the APs in the same group.

    <img src="../../../images/c200p/apgroup-config.webp" alt="" width="500px" style="border: 1px solid #eee; display:block; margin:0 auto;" />
...
- <img src="../../../images/c200p/upgrade.webp" alt=""/>: Upgrade the firmwares of the APs in the group.

- <img src="../../../images/c200p/forget.webp" alt=""/>: Forget and remove AP groups from controller but still in the network.

- <img src="../../../images/c200p/reboot.webp" alt=""/>: Reboot the AP systems remotely for fixes/updates.

<img src="../../../images/noteicon.webp" alt="" /> APs in the same AP group will share an identical SSID, while different AP groups should have different SSIDs. Refer to [General Settings -> Wireless](wireless.md) for more detailed configurations.