...
## Overview
- Check the [package content](overview_wr300s.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr300s.md#front-panel){ data-preview } and [back](overview_wr300s.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr300s.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr300s.md#front-panel){ data-preview } status and indication.
...
- *Wireless 2.4G* shows the Wireless 2.4G status. Click [*More Details*](wireless_2.4g.md){ data-preview } to know more information about it or make changes on Settings page. 
...
### II. General Settings
- [WAN Mode](wan.md){ data-preview }: Set your Internet connection. Select your Internet connection type from the drop-down list of Protocol. Follow the instructions on the page to complete the configuration.
...
- [Wireless 2.4G](wireless_2.4g.md){ data-preview }: Customize the router's 2.4G wireless settings, including SSID and password, mode, channel, channel width and transmit power, and so on.
...
- [Time Zone](system.md#system-time){ data-preview }: Select your time zone appropriately for some time-based functions.
