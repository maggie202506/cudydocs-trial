...
## Overview
- Check the [package content](overview_wr1500.md#package-content){ data-preview }.
- View the router's appearance, and check the  [interface](overview_wr1500.md#front-panel--back-panel){ data-preview } instructions as well as the [LED](overview_wr1500.md#front-panel--back-panel){ data-preview } indication.
...
- *WISP* shows the connected HOST Network status, its SSID and Upload/Download speed. Click [*More Details*](wisp.md){ data-preview } to know more information about it or make changes.
