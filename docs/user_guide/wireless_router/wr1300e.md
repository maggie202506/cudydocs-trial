...
## Overview
- Check the [package content](overview_wr1300e.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr1300e.md#front-panel){ data-preview } and [back](overview_wr1300e.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr1300e.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr1300e.md#front-panel){ data-preview } status and indication.
