...
- View the [interaces](overview.md#back-panel){ data-preview } layout and description. 
...
## Management
### I. System Status
- View the status of the router, including [*Device*](status.md#device){ data-preview }, [*WAN*](status.md#wan){ data-preview }, [*LAN*](status.md#lan){ data-preview }, [*Wireless 2.4G/5G*](status.md#wireless-24g){ data-preview }, [*IPv6*](status.md#ipv6){ data-preview }, [*VPN*](status.md#vpn){ data-preview }, [*DHCP*](status.md#dhcp-server){ data-preview } and [*System*](status.md#system){ data-preview }.
