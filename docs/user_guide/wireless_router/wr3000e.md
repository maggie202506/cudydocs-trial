...
## Overview
- Check the [package content](overview_wr3000e.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr3000e.md#front-panel){ data-preview } and [back](overview_wr3000e.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr3000e.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr3000e.md#front-panel){ data-preview } status and indication.
