...
## Overview
- Check the [package content](overview_wr1200.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr1200.md#front-panel){ data-preview } and [back](overview_wr1200.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr1200.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr1200.md#front-panel){ data-preview } status and indication.
...
- [Wireless 5G](wireless_5g.md){ data-preview }: Customize the router's 5G wireless settings, including SSID and password, mode, channel, channel width and transmit power, and so on.
