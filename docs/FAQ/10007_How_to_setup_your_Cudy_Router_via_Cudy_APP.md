...
<img src="../../images/FAQ/10007/1_Cudy_APP_QR.webp" alt="CudyAPP" width="300px" style="display: block; margin: 0 auto;">
...
<img src="../../images/FAQ/10007/2_Network_topology.webp" alt="topology" width="800px" style="display: block; margin: 0 auto;">
...
1. Check the default Wi-Fi SSID  (Cudy-XXXX and Cudy-XXXX-5G) and the Wi-Fi password on the label of the router. As shown below.
    ...
    <img src="../../images/FAQ/10007/3_SSID_label.webp" alt="label" width="300px" style="display: block; margin: 0 auto;">

2. Go to your phone’s Wi-Fi settings and connect it to your Cudy router’s Wi-Fi network. 

    <img src="../../images/FAQ/10007/4_connect_WiFi.webp" alt="conncet" width="300px" style="display: block; margin: 0 auto;">

3. Open the Cudy APP. You will find the Cudy router on the Dashboard automatically.

    <img src="../../images/FAQ/10007/5_APP_dashboard.webp" alt="dashboard" width="300px" style="display: block; margin: 0 auto;">

4. Tap on your router icon. You need to create or input administrator password to login to the router.

    <img src="../../images/FAQ/10007/6_WR3000_create_password.webp" alt="create_password" width="300px" style="display: block; margin: 0 auto;">

5. The Quick Setup will auto-launch.  Choose the "Wireless Router" mode and tap "Next".

    <img src="../../images/FAQ/10007/7_working_mode.webp" alt="working_mode" width="300px" style="display: block; margin: 0 auto;">
...
6. Set your Time Zone and tap "Next". The "Auto Update" is enabled by default. If you don't want to update the firmware of your router automatically, please disable it.
    ...
    <img src="../../images/FAQ/10007/8_time_zone.webp" alt="time_zone" width="300px" style="display: block; margin: 0 auto;">

7. Set the WAN connection parameters and tap "Next".

    <img src="../../images/FAQ/10007/9_WAN_protocol.webp" alt="WAN_protocol" width="300px" style="display: block; margin: 0 auto;">
    ...
    - DHCP
        ...
        <img src="../../images/FAQ/10007/10_dhcp.webp" alt="dhcp" width="300px" style="display: block; margin: 0 auto;">
    ...
    - PPPoE
        ...
        PPPoE is a protocol used by many Internet Service Providers (ISPs). Generally, your ISP will provide a modem and give you the username & password that you need when setting up the Internet connection.
         ...
         <img src="../../images/FAQ/10007/11_PPPoE.webp" alt="PPPoE" width="300px" style="display: block; margin: 0 auto;">
    ...
    - Static(Fixed IP)
        ...
        <img src="../../images/FAQ/10007/12_static_IP.webp" alt="static_IP" width="300px" style="display: block; margin: 0 auto;">
    ...
    - L2TP and PPTP
        ...
        L2TP and PPTP are VPN protocols and can also be used for WAN connection. They are not a common protocol. You must input proper parameters to access the internet.
         ...
         <img src="../../images/FAQ/10007/13_L2TP_PPTP.webp" alt="L2TP_PPTP" width="600px" style="display: block; margin: 0 auto;">
    ...
    - IPTV/VLAN
        ...
        <img src="../../images/FAQ/10007/14_iptv_templates.webp" alt="iptv_templates" width="600px" style="display: block; margin: 0 auto;">
        ...
        <img src="../../images/FAQ/10007/15_IPTV_Custom.webp" alt="IPTV_Custom" width="300px" style="display: block; margin: 0 auto;">
        ...
        <img src="../../images/FAQ/10007/16_IPTV_VLAN_example.webp" alt="IPTV_VLAN_example" width="300px" style="display: block; margin: 0 auto;">
...
8. Set the Wireless parameters and tap "Next".
    ...
    <img src="../../images/FAQ/10007/17_wireless.webp" alt="wireless" width="300px" style="display: block; margin: 0 auto;">
    ...
    <img src="../../images/FAQ/10007/18_WPA2_WPA3.webp" alt="WPA2_WPA3" width="300px" style="display: block; margin: 0 auto;">

9. Check all the settings and tap "Apply". Click "Yes" to allow the router to restart. The settings are finished.

    <img src="../../images/FAQ/10007/19_Check_all_settings.webp" alt="Check_all_settings" width="300px" style="display: block; margin: 0 auto;">
...
10. Then connect to the new Wi-Fi name you set before and login to the router again. Check the status of the router. The router will connect to the internet successfully.
    ...
    <img src="../../images/FAQ/10007/20_set_done.webp" alt="set_done" width="300px" style="display: block; margin: 0 auto;">
