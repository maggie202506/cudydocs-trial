...
1. Please prepare a TFTP tool on your computer in advance.
    <img src="../../images/FAQ/10002/tftp_tool.png" alt="tftp" width="600px" style="display: block; margin: 0 auto;" >
...
5. Then **right-click** to run the tftp tool as an administrator.
    <img src="../../images/FAQ/10002/run_tftp.png" alt="run tftp" width="500px" style="display: block; margin: 0 auto;" >
...
6. Press and hold the RESET button on the router body (do not release it), then power on the router. When TFTP starts transmitting data, release the RESET button.
    <img src="../../images/FAQ/10002/upload_firmware_via_tftp.png" alt="tftp" width="500px" style="display: block; margin: 0 auto;" >
